...
from .views import PaymentCreateView,StudentPaymentDetailsView,AdminPaymentListView, PaymentStatusUpdateView,StudentPaymentStatusView,PaymentSlipAPIView,SinglePaymentGetAPIView
urlpatterns = [
    ...
    path('single-payment/<int:id>',SinglePaymentGetAPIView.as_view(),name="single-payment")
